...
def get_args_parser(add_help=True):
    ...
    parser = argparse.ArgumentParser(
        description="PyTorch QQP Classification Training", add_help=add_help)
    parser.add_argument(
        "--data_cache_dir", default=None, help="data cache dir.")
    parser.add_argument("--task_name", default="qqp",
                        help="the name of the glue task to train on.")
    parser.add_argument("--model_name_or_path", default="/root/autodl-tmp/PaddleFNet/model/pytorch/fnet-large/",
...
if __name__ == "__main__":
    ...
    reprod_logger.save("qqp_train_align_benchmark.npy")
    np.save("torch_qqp_losses.npy", np.array(losses))
