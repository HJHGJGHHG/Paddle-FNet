...
def train_one_epoch(
    ...
    for batch in metric_logger.log_every(data_loader, print_freq, header):
        ...
        writer.add_scalars('torch_loss', loss.item(), epoch * len(data_loader) + i)
...
def get_args_parser(add_help=True):
    ...
    parser = argparse.ArgumentParser(
        description="PyTorch CoLA Classification Training", add_help=add_help)
    parser.add_argument(
        "--data_cache_dir", default=None, help="data cache dir.")
    parser.add_argument("--task_name", default="cola",
                        help="the name of the glue task to train on.")
    parser.add_argument("--model_name_or_path", default="google/fnet-large",
    ...
    parser.add_argument("--max-instances", default=5000, type=int,
                        help="stop after training how many instances")
