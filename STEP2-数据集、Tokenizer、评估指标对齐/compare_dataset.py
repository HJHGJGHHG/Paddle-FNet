...
from transformers.models.fnet import FNetForSequenceClassification as PTFNetForSequenceClassification
...
def main():
    ...
    pt_dataset = load_dataset('glue', 'sst2')
    pd_train_dataset = paddlenlp.datasets.load_dataset("glue", 'sst-2', splits="train")
    pd_dev_dataset = paddlenlp.datasets.load_dataset("glue", 'sst-2', splits="dev")
    ...
    # dev dataset
    torch_dev_dataset = CoLADataset_torch(args, pt_dataset, phase='validation')
    paddle_dev_dataset = CoLADataset_paddle(args, pd_dev_dataset, phase='validation')
    # train dataset
    torch_train_dataset = CoLADataset_torch(args, pt_dataset, phase='train')
    paddle_train_dataset = CoLADataset_paddle(args, pd_train_dataset, phase='train')
    ...
    compare_dataset(torch_dev_dataset, paddle_dev_dataset, torch_dev_iter, paddle_dev_iter)
